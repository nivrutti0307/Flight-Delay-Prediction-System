...
MODEL_PATH = BASE_DIR / "models" / "flight_delay_predictor.pkl"

# Page configuration
st.set_page_config(
    page_title="Flight Delay Prediction System ✈️",
    page_icon="✈️",
    layout="wide",
...
@st.cache_resource
def load_model():
    return FlightDelayPredictor.load(MODEL_PATH)
...
# Main app
st.markdown('<div class="main-header"><h1>✈️ Flight Delay Prediction System</h1><p>Get predictions for your flight delays</p></div>', unsafe_allow_html=True)
